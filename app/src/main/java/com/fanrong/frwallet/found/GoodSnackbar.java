...
public class GoodSnackbar {
    ...
    public static void showMsg(Activity activity, String msg) {
        View contentView = View.inflate(activity, R.layout.mysnackbar_layout, null);
        TextView tvMsg = contentView.findViewById(R.id.tv_msg);
        tvMsg.setText(msg);
        make(activity).setMyView(contentView).show();
    ...
    public static GoodSnackbar make(Activity parent) {
        return new GoodSnackbar((ViewGroup) parent.findViewById(android.R.id.content));
    }
