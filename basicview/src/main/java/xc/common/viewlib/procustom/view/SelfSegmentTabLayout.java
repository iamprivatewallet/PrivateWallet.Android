package xc.common.viewlib.procustom.view;
 ...
 * 自定义渐变背景
 */
public class SelfSegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public SelfSegmentTabLayout(Context context) {
        this(context, null, 0);
    }

    public SelfSegmentTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SelfSegmentTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mRectDrawable.setStroke((int) mBarStrokeWidth, mBarColor);
...
//        mIndicatorDrawable.setColor(mIndicatorColor);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            mIndicatorDrawable.setColors(new int[]{Color.parseColor("#A875FF"), Color.parseColor("#39A1F7")});
