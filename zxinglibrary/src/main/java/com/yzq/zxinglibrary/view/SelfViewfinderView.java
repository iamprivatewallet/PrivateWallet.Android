...
public final class SelfViewfinderView extends View {
    ...
    public SelfViewfinderView(Context context) {
        this(context, null);

    }

    public SelfViewfinderView(Context context, AttributeSet attrs) {
    ...
    public SelfViewfinderView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
