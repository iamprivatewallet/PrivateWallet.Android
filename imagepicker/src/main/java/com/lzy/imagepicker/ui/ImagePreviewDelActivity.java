...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    private void showDeleteDialog() {
        ...
        builder.setTitle(R.string.ip_ImagePreviewDelActivity_text1);
        builder.setMessage(R.string.ip_ImagePreviewDelActivity_text2);
        builder.setNegativeButton(R.string.ip_ImagePreviewDelActivity_text3, null);
        builder.setPositiveButton(R.string.ip_ImagePreviewDelActivity_text4, new DialogInterface.OnClickListener() {
            @Override
